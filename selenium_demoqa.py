...
try:
    ...
    # page_name = driver.find_element(By.XPATH, "//xpath[text()='Buttons']")
    ...
    for link_id, friendly_name in links:
        link = driver.find_element(By.ID, link_id)
        link_text = link.text
        assert link.is_displayed()
        print(f"✅ Passed, link {friendly_name} is: {link_text}\n")
